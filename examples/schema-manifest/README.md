...
```bash
pnpm run db -- sync --cwd ./examples/schema-manifest
pnpm run db -- schema manifest --cwd ./examples/schema-manifest --out ./src/generated/db.schema.json
pnpm run db -- serve --cwd ./examples/schema-manifest
```

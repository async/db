...
```bash
pnpm run db -- sync --cwd ./examples/content-collections
pnpm run db -- serve --cwd ./examples/content-collections
```
...
```bash
pnpm run db -- schema bundle --all --cwd ./examples/content-collections --out db.schema.js
```

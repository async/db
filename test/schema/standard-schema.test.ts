...
import { executeGraphql as typedExecuteGraphql, generateTypes as typedGenerateTypes, loadConfig as typedLoadConfig, loadDbSchema as typedLoadDbSchema, openDb as typedOpenDb, syncDb as typedSyncDb } from '../../src/index.js';
...
`);
  ...
  assert.throws(
    ...
    (error: any) => error.code === 'DB_SCHEMA_ASYNC_VALIDATOR_REQUIRED'

...
const registerDbRoutes = (app: unknown, db: unknown, options?: unknown): void => {
  typedRegisterDbRoutes(app as never, db as never, options as never);
};
...
function fakeHonoContext(options: any = {}): any {
  const headers: Record<string, unknown> = {};
  function response(body, status, responseHeaders = {}): any {
